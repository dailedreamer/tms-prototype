      ...
      <div class="panel panel-default">
        <div class="panel-body body_design_main">
          <div class="panel_design_title">
            <h4><span class="iconify" data-icon="flat-ui:graph" data-inline="false" width="35" height="35"></span>
             QUOTATIONS
            </h4>
          </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row col-lg-12">
                      <div class="col-lg-3">
                        ...
                        <img src="img/undraw_profile_pic_ic5t.png" height="300px;">
                      </div>
                      ...
                      <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" style="height:125px">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <label for="">Product Approved :</label>
                            <input type="text" class="form-control">
                          </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6"><button class="btn btn-danger btn-block">Cancel</button></div>
                    </div>
                </div>
              </div>
            </div>
