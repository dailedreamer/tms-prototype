      ...
      <div class="panel panel-default">
        <div class="panel-body body_design_main">
          <div class="panel_design_title">
            <h4><span class="iconify" data-icon="flat-ui:box" data-inline="false" width="35" height="35"></span>
          ...
          <div class="row">
            ...
            <div class="form-group" style="margin-left:30px;">
              <label for="" style="color:white;">.</label><br>
              <button class="btn btn-success">View Latest Request</button>
            </div>
          </div>
            ...
            <table class="table table-striped table-bordered" id="table_example" width="100%">
              ...
              <tbody>
                <tr>
                  ...
                  <td>SAMPLE</td>
                  <td>SAMPLE</td>
                  <td><button class="btn btn-success" data-toggle="modal" data-target="#exampleModal">View Item</button></td>
                </tr>
              </tbody>
            </table>
          </div> 
