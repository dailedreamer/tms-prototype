              ...
              <div class="col-lg-12">
                <table class="table table-striped table-bordered" id="table_example" width="100%">
                  ...
                  <thead>
                    <tr>
                      <td rowspan="2">NO</td>
                      <td colspan="3"><center>REQUEST BY</td>
                      <td rowspan="2">AREA</td>
                      <td rowspan="2">REQUEST DATE</td>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><button class="btn btn-warning" data-toggle="modal" data-target="#exampleModal">View Item</button></td> 
                    </tr>
                  </tbody>
                </table>
              </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="container row">
            <div class="col-lg-3">
              <div style="background-color:powderblue; padding-left:10px; padding-right:5px; padding-top:40px; padding-bottom:40px; margin-bottom:20px;">
                <h4 >JEROME PENTASON</h4>
                <h4><SMALL>MACHINING SECTION</SMALL></h4>
              </div>
              <button class="btn btn-primary btn-block">APPROVE REQUEST</button>
              <button class="btn btn-danger btn-block">CANCEL REQUEST</button>
            </div>
            ...
            <table class="table table-striped table-bordered" id="table_example2" width="100%">
                ...
                <thead>
                  <tr>
                    ...
                    <td>QUANTITY</td>
                    <td>AREA STOCKS</td>
                    <td>INTENDED MACHINE TO BE </br>PURPOSE OF ISSUANCE</td>
                  </tr>
                </thead>
                <tbody>
                  <tr>
