      ...
      <div class="panel panel-default">
        <div class="panel-body body_design_main">
          <div class="panel_design_title">
            <h4><span class="iconify" data-icon="emojione-v1:pen-over-stamped-envelope" data-inline="false" width="35" height="35"></span>
            ASSIGNATORY
            </h4>
          </div>
          ...
          <!-- BODY HERE -->
            ...
            <div class="col-lg-12 row">
              <div class="col-lg-3">
                <CENTER>
                <button class="btn btn-primary" style="height:150px; width:150px; margin:20px;">PR REQUEST ASSIGNATORY</button> 
                <button class="btn btn-primary" style="height:150px; width:150px; margin:20px;">REQUEST FORM ASSIGNATORY</button>
                <button class="btn btn-primary" style="height:150px; width:150px; margin:20px;">REQUEST FOR DR ASSIGNATORY</button>
                <button class="btn btn-primary" style="height:150px; width:150px; margin:20px;">COMPLETION ASSIGNATORY</button>
              </div>
              <div class="col-lg-9">
              <button class="btn btn-success" style="margin-bottom:30px;">Add New Assignent</button>
